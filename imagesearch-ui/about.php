...
<head>
	...
	<title>CC Image Search - About</title>
	<!-- StyleSheets-->
...
<div class="container">
  ...
  <div class="col-xs-8 center-block" style="float:none; margin-bottom: 15px;">
    ...
    <p>Please <a href="http://littlesvr.ca/contact.php?source=CC%20Registry">get in touch</a> if this is in any way interesting to you, I would love to answer questions about how it works, and how you could use it.</p>
    </div>
</div>
